...
@endsection
@section('title')
    Update Latest Product | Dashboard
@endsection
                        ...
                        <div class="row">
                            <div class="mx-xl-auto col-xl-10 col-md-12">
                                <div class="card card-default">
                                    ...
                                    <div class="card-body">
                                        <div class="card-body">
                                            <form class="admin-form" action="{{ route('latest.update', $latest->id) }}" method="POST"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <br>
                                                    <img width="110px;" class="admin-img"
                                                        src="{{ $latest->thumbnail ? asset('assets/images/'.$latest->thumbnail) : asset('assets/images/placeholder.png') }}"
                                                        alt="No Image Found">
                                                        <br>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" rows="4" class="form-control item-name" >{{ $latest->description }}</textarea>
                                            </div>
