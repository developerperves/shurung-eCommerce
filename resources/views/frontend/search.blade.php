...
@section('frontendContent')
     <!-- hero header section -->
     <div class="hero-header hero-header--shop" style="background-image: url('{{ asset('assets/images') }}/{{ setting()->serch_banner_bg }}')">
                ...
                <div class="col-12">
                    <div class="hero-header__wrapper">
                        <div class="inner-content">
                            <h2 class="title">
                                <span class="title--md">{{ setting()->serch_banner_heading }}</span>
                            </h2>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="product-card product-card--block">
                                <div class="product-card__img">
                                    <a href="{{ route('product.detail', $search->slug) }}">
                                        <img src="{{ asset('assets/images') }}/{{ $search->photo }}" alt="{{ $search->photo }}">
                                    </a>
                                    <div class="product-card__overlay">
                                        @if ($search->previous_price != null)   
                                        <div class="product-badge">
                                            -{{ App\Helpers\PriceHelper::DiscountPercentage($search) }}
                                        </div>
                                        @endif
                                        <div class="product-actions">
                                            <ul class="product-btn-list">
                                                <li>
                                                    <a href="{{ route('product.detail', $search->slug) }}" class="product-btn"><i class="icon-eye"></i></a>
                                                </li>
                                                <li>
                                ...
                                <div class="product-card__body">
                                    <div class="product-category">{{ App\Brand::find($search->brand_id)->name }}</div>
                                    <h3 class="product-name">
                                        <a href="{{ route('product.detail', $search->slug) }}">{{ $search->name }}</a>
                                    </h3>
                                    <div class="product-price">
                                        @if ($search->previous_price!=null)
                                        <del class="old">
                                            <span class="amount">TK.  {{ $search->previous_price }}</span></del>
                                        @endif
                                        <ins class="current ">
                                            <span class="amount">TK.  {{ $search->discount_price }}</span>
                                        </ins>
                                    </div>
                                </div>
                            </div>
